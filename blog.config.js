...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'ac76ed1878fb42f2b9b07e4e4b7b5809',
  ...
  AUTHOR: 'crown', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://corwn.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/crownheaven', // 你的github个人主页
